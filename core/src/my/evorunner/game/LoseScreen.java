...
//Shows the ending screen for losers in multiplayer games
public class LoseScreen implements Screen {
    ...
    //parameter
    public LoseScreen (EvoRunner parent) {
        this.parent = parent;
        random = new Random();
    }
    ...
    private void setUpStage(Stage stage) {
        ...
        Label youRan = new Label("You Lose ;(",labelStyle);
        table.add(youRan);
        ...
        back.setPosition(70,SCREEN_HEIGHT * 7 / 8);
